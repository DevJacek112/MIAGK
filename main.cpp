...
int main() {
    ...
    std::shared_ptr<Cone> cube2 = std::make_shared<Cone>(float3(-1,0,-1), 0.5, 32, camera._view2Proj, camera._world2View, camera._obj2world);
    ...
    std::shared_ptr<Cone> cube5 = std::make_shared<Cone>(float3(1,1,-1), 0.5, 32, camera._view2Proj, camera._world2View, camera._obj2world);
    std::shared_ptr<Cone> cube6 = std::make_shared<Cone>(float3(1,-1,-1), 0.5, 32, camera._view2Proj, camera._world2View, camera._obj2world);
    ...
    std::shared_ptr<PointLight> pointLight = std::make_shared<PointLight>(float3(0, 0, -0.5), float3(0.05f, 0.05f, 0.05f),
